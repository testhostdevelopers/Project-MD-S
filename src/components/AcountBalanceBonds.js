...
const AcountBalanceBonds = (props) => {
   ...
   return (
      <React.Fragment>
         <div className="gray-bg ms p-4 mb-4 mb-md-0">
            ...
            <div className="withdraw-text ms mt-2">
               ...
               <div className="border-top d-flex justify-content-center">
                  {/* data-bs-toggle="modal" data-bs-target="#stakeCryptoModal" onClick={() => setBoundTabs(false)} */}
                  <div className="py-3 text-center">
                     <button data-bs-toggle="modal" data-bs-target="#stakeCryptoModal" type="button" className="withdraw-btn mx-auto py-3 px-5">
                        Stake
                     </button>
                  </div>
         ...
         {/*** Stake MsDoge Modal - 1 ***/}
         <div className="modal fade" id="stakeMsDogeModal" tabIndex="-1" aria-labelledby="stakeMsDogeModalLabel" aria-hidden="true">
                  ...
                  <div className="modal-dialog">
                     <div className="modal-content icon-text-block-cri">
                        <div className="modal-body popup-card-container rel">
                           ...
                           <div className="heading-text-popupm">
                              <h5 className="my-3 text-center ">Bond</h5>
                              <div>
                              ...
                              <div>
                                 ...
                                 <div className="mt-4 heading-text-popupm d-flex justify-content-between">
                                    <div className="w-100 text-center">
                                       ...
                                       <h3><b className="text-gold size-19">$110</b></h3>
                                    </div>
         ...
         {/*** Approve MsDoge Modal ***/}
         <div className="modal fade" id="msDogeApprove" tabIndex="-1" aria-labelledby="stakeCryptoModalLabel" aria-hidden="true">
            <div className="modal-dialog">
               <div className="modal-content icon-text-block-cri">
                  <div className="modal-body popup-card-container rel">
                     <button type="button" className="closebtn p-0" data-bs-dismiss="modal" aria-label="Close">
         ...
         <div className="modal fade" id="stakeCryptoModal" tabIndex="-1" aria-labelledby="stakeMsDogeModalLabel" aria-hidden="true">
                  ...
                  <div className="modal-dialog">
                     <div className="modal-content icon-text-block-cri">
                        <div className="modal-body popup-card-container rel">
                           ...
                           <div className="heading-text-popupm">
                              <h5 className="my-3 text-center ">Bonds</h5>
                              <div>
