            ...
            <div className="withdraw-text ms mt-2">
               ...
               <div className="row border-top">
                  <div className="col-12 py-3 text-center">
                     <button data-bs-toggle="modal" data-bs-target="#stakeCryptoModal" onClick={() => setBoundTabs(false)} type="button" className="withdraw-btn mx-auto py-3 px-5">
                        Stake
                     </button>
                  </div>
