               ...
               <div className="modal-content">
                  <div className="modal-body popup-card-container rel">
                     <header className="d-flex justify-content-between pt-0 pb-0 align-items-center">
                        ...
                        <div className="cursor-pointer" data-bs-toggle="modal" data-bs-target="#hadesPopup">
                           <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div className="input-bal">
                                 <div className="row">
                                    ...
                                    <div className="col-sm-12">
                                       ...
                                       <div className="p-2 stake-btn">
                                          <a type="button" className="table-btn btn py-2 px-4 w-100 mb-3">Approve 0.5 URUS</a>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div className="heading-text-popupm">
                        <div className="input-bal">
                           <div className="row pt-5">
                              ...
                              <div className="col-sm-12">
                                 <div className="p-2 stake-btn">
                                    <a type="button" className="table-btn btn w-100 mb-3">Confirm Transaction</a>
                                 </div>
                              </div>
                           </div>
                        </div>
...
export default connect(mapStateToProps, null)(ListOfMigrate);